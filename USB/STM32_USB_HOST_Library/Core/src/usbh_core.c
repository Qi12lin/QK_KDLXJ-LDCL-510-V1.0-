...
//	if (HCD_IsDeviceConnected(pdev) == 0) //U盘未连接，退出U盘拷贝
//	{
...
//			if (Timer_1S[U_DISC_CONNECT] == 0) //U盘检测时间
//			{
//				HldReg[COPY_FINISH_TIPS] = 2;//U盘拷贝提示：2－U盘未连接提示				
//				HldReg[RUNDATA_TO_U_DISC] = 0;
//				HldReg[ALARMDATA_TO_U_DISC] = 0;
//			}
//		}
//	}    
  switch (phost->gState)
